...
# ==================== SCREENING PARAMS ====================
BATCH_SIZE = 50
SLEEP_BETWEEN_BATCHES = 3.0  # detik, anti-spam

# Filter Zombie (saham mati)
MIN_VOLUME = 150_000          # 150 ribu saham/hari
MIN_TRANSACTION_VALUE = 1_000_000_000  # Rp 1 Miliar/hari

# Harga 1 lot = Rp 800.000 → harga/saham = Rp 8.000
HIGH_PRICE_THRESHOLD = 8_000
...
# ==================== DAFTAR SAHAM LENGKAP (1002 SAHAM) ====================
# Sumber: daftar yang Anda berikan, sudah di-sort & di-deduplicate otomatis
STOCK_LIST = [
...
# Hapus duplikat (jika ada) dengan set, tapi pertahankan urutan
unique_stocks = []
for s in STOCK_LIST:
    if s not in unique_stocks:
        unique_stocks.append(s)
STOCK_LIST = unique_stocks

print(f"[CONFIG] Total saham unik: {len(STOCK_LIST)}")
