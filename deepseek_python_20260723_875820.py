...
class StockScreener:
    ...
    def run_screening(self):
        """Jalankan screening untuk semua saham"""
    ...
    def get_detail(self, ticker):
        """Dapatkan detail lengkap 1 saham (10 kriteria)"""
        data = self.fetcher.get_stock_info(ticker)
        if not data:
...
"""
    ...
    def _calculate_moat(self, data):
        ...
        # ROE tinggi = moat kuat
        if data.get("roe", 0) > 20:
            score += 2
        elif data.get("roe", 0) > 15:
            score += 1
        
        # Sektor tertentu punya moat alami
    ...
    def _calculate_risk(self, data):
        ...
        # Volatilitas (proksi dari perubahan harga)
