# ===== SUPER SCREENER - FINAL (PESAN DIPOTONG AGAR TIDAK 400) =====
...
# ========== KONFIGURASI ==========
TOKEN = "8815512475:AAFrS-5U6ZdcpC0qLylWUp1IkeUysiEmBdw"
CHAT_ID = "8467853860"
# =================================
...
# === PESAN TELEGRAM (HANYA 10 TERBAIK + 5 PANTAUAN) ===
...
# Kirim
print(f"📏 Panjang pesan: {len(pesan)} karakter")
if kirim_pesan(pesan):
    print("✅ Selesai! Cek Telegram.")
else:
    print("❌ Gagal mengirim. Coba periksa Token dan Chat ID.")
